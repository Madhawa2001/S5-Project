    ...
    return (
      ...
      <div className="w-full max-w-md bg-white rounded-lg shadow-lg border border-green-200 p-6">
        ...
        <div className="space-y-4">
          ...
          <button className="w-full border border-green-300 text-green-700 hover:bg-green-50 bg-transparent font-medium py-2 px-4 rounded-md transition-colors flex items-center justify-center">
